                        ...
                        <div class="col-md-6" id="shippingCoverageField" style="display: none;">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('shipCoverage') is-invalid @enderror"
                                    ...
                                    <option value="Town" {{ old('shipCoverage') == 'Town' ? 'selected' : '' }}>Town</option>
                                    <option value="Province" {{ old('shipCoverage') == 'Province' ? 'selected' : '' }}>Province</option>
                                    <option value="Region" {{ old('shipCoverage') == 'Region' ? 'selected' : '' }}>Region</option>
                                    <option value="National" {{ old('shipCoverage') == 'National' ? 'selected' : '' }}>National</option>
                                </select>
