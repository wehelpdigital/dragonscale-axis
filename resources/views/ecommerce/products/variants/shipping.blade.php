...
@section('title') Variant Shipping @endsection
...
@slot('title') Variant Shipping @endslot
@endcomponent
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('ecom-products.variants', ['id' => $product->id]) }}" class="btn btn-back">
            ...
            <div class="card-body">
                ...
                <div class="variant-info">
                    <div class="variant-name">{{ $variant->ecomVariantName }}</div>
                    <div class="variant-details">
                        <strong>Product:</strong> {{ $product->productName }} |
                        <strong>Price:</strong> ₱{{ number_format($variant->ecomVariantPrice, 2) }}
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    let currentSearch = '';
    let searchTimeout;
    let currentVariantId = parseInt('{{ $variant->id }}');
