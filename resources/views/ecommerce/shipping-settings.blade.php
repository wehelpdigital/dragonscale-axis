...
@slot('li_2') <a href="{{ route('ecom-shipping') }}">Shipping Methods</a> @endslot
@slot('title') Shipping Settings @endslot
@endcomponent
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="card-title">Shipping Settings - {{ $shipping->shippingName }}</h4>
