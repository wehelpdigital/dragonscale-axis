    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="discountForm" method="POST" action="{{ route('ecom-discounts.update') }}" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="discountName" name="discountName" placeholder="Enter discount name" value="{{ old('discountName', $discount->discountName) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="discountDescription" name="discountDescription" rows="4" placeholder="Enter discount description" required>{{ old('discountDescription', $discount->discountDescription) }}</textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="discountType" name="discountType" required>
                            ...
                            <option value="Product Discount" {{ old('discountType', $discount->discountType) == 'Product Discount' ? 'selected' : '' }}>Product Discount</option>
                            <option value="Shipping Discount" {{ old('discountType', $discount->discountType) == 'Shipping Discount' ? 'selected' : '' }}>Shipping Discount</option>
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="discountTrigger" name="discountTrigger" required>
                            ...
                            <option value="Auto Apply" {{ old('discountTrigger', $discount->discountTrigger) == 'Auto Apply' ? 'selected' : '' }}>Auto Apply</option>
                            <option value="Discount Code" {{ old('discountTrigger', $discount->discountTrigger) == 'Discount Code' ? 'selected' : '' }}>Discount Code</option>
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group" id="discountCodeField" style="display: none;">
                        ...
                        <input type="text" class="form-control" id="discountCode" name="discountCode" placeholder="Enter discount code" value="{{ old('discountCode', $discount->discountCode) }}">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="amountType" name="amountType" required>
                            ...
                            <option value="Percentage" {{ old('amountType', $discount->amountType) == 'Percentage' ? 'selected' : '' }}>Percentage</option>
                            <option value="Specific Amount" {{ old('amountType', $discount->amountType) == 'Specific Amount' ? 'selected' : '' }}>Specific Amount</option>
                            <option value="Price Replacement" {{ old('amountType', $discount->amountType) == 'Price Replacement' ? 'selected' : '' }}>Price Replacement</option>
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group" id="valuePercentField" style="display: none;">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" id="valuePercent" name="valuePercent" placeholder="Enter percentage value" step="0.01" min="0" max="100" value="{{ old('valuePercent', $discount->valuePercent) }}">
                    ...
                    <div class="form-group" id="valueAmountField" style="display: none;">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="valueAmount" name="valueAmount" placeholder="Enter amount" step="0.01" min="0" value="{{ old('valueAmount', $discount->valueAmount) }}">
                        </div>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group" id="valueReplacementField" style="display: none;">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Php</span>
                            <input type="number" class="form-control" id="valueReplacement" name="valueReplacement" placeholder="Enter replacement price" step="0.01" min="0" value="{{ old('valueReplacement', $discount->valueReplacement) }}">
                        </div>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="discountCapType" name="discountCapType" required>
                            ...
                            <option value="None" {{ old('discountCapType', $discount->discountCapType) == 'None' ? 'selected' : '' }}>None</option>
                            <option value="Total" {{ old('discountCapType', $discount->discountCapType) == 'Total' ? 'selected' : '' }}>Total</option>
                            <option value="Per Product" {{ old('discountCapType', $discount->discountCapType) == 'Per Product' ? 'selected' : '' }}>Per Product</option>
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group" id="discountCapValueField" style="display: none;">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Php</span>
                            <input type="number" class="form-control" id="discountCapValue" name="discountCapValue" placeholder="Enter cap value" step="0.01" min="0" value="{{ old('discountCapValue', $discount->discountCapValue) }}">
                        </div>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="usageLimit" name="usageLimit" placeholder="Enter usage limit" min="0" value="{{ old('usageLimit', $discount->usageLimit) }}" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" id="expirationType" name="expirationType" required>
                            ...
                            <option value="Time and Date" {{ old('expirationType', $discount->expirationType) == 'Time and Date' ? 'selected' : '' }}>Time and Date</option>
                            <option value="Countdown" {{ old('expirationType', $discount->expirationType) == 'Countdown' ? 'selected' : '' }}>Countdown</option>
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group" id="dateExpirationField" style="display: none;">
                        ...
                        <input type="text" class="form-control" id="dateExpiration" name="dateExpiration" placeholder="Select date" readonly value="{{ old('dateExpiration', $discount->dateTimeExpiration ? \Carbon\Carbon::parse($discount->dateTimeExpiration)->format('F j, Y') : '') }}">
                        <div class="invalid-feedback"></div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <select class="form-select" id="timeHour" name="timeHour">
                                    ...
                                    @endphp
                                    <option value="01" {{ $timeHour == '01' ? 'selected' : '' }}>01</option>
                                    <option value="02" {{ $timeHour == '02' ? 'selected' : '' }}>02</option>
                                    <option value="03" {{ $timeHour == '03' ? 'selected' : '' }}>03</option>
                                    <option value="04" {{ $timeHour == '04' ? 'selected' : '' }}>04</option>
                                    <option value="05" {{ $timeHour == '05' ? 'selected' : '' }}>05</option>
                                    <option value="06" {{ $timeHour == '06' ? 'selected' : '' }}>06</option>
                                    <option value="07" {{ $timeHour == '07' ? 'selected' : '' }}>07</option>
                                    <option value="08" {{ $timeHour == '08' ? 'selected' : '' }}>08</option>
                                    <option value="09" {{ $timeHour == '09' ? 'selected' : '' }}>09</option>
                                    <option value="10" {{ $timeHour == '10' ? 'selected' : '' }}>10</option>
                                    <option value="11" {{ $timeHour == '11' ? 'selected' : '' }}>11</option>
                                    <option value="12" {{ $timeHour == '12' ? 'selected' : '' }}>12</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <select class="form-select" id="timeMinute" name="timeMinute">
                                    <option value="">Minute</option>
                                    <option value="00" {{ $timeMinute == '00' ? 'selected' : '' }}>00</option>
                                    <option value="15" {{ $timeMinute == '15' ? 'selected' : '' }}>15</option>
                                    <option value="30" {{ $timeMinute == '30' ? 'selected' : '' }}>30</option>
                                    <option value="45" {{ $timeMinute == '45' ? 'selected' : '' }}>45</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <select class="form-select" id="timePeriod" name="timePeriod">
                                    <option value="">AM/PM</option>
                                    <option value="AM" {{ $timePeriod == 'AM' ? 'selected' : '' }}>AM</option>
                                    <option value="PM" {{ $timePeriod == 'PM' ? 'selected' : '' }}>PM</option>
                                </select>
                            </div>
                        </div>
                        <input type="hidden" id="timeExpiration" name="timeExpiration" value="{{ $existingTime }}">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group" id="countdownMinutesField" style="display: none;">
                        ...
                        <input type="number" class="form-control" id="countdownMinutes" name="countdownMinutes" placeholder="Enter countdown minutes" min="0" value="{{ old('countdownMinutes', $discount->timerCountdown) }}">
                        <div class="invalid-feedback"></div>
                    </div>
