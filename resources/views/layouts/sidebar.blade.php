            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li>
                            <a href="{{ route('ecom-products') }}" class="waves-effect">
                        ...
                        <li>
                            <a href="{{ route('ecom-discounts') }}" class="waves-effect">
                                <i class="bx bx-tag"></i>
                                <span key="t-discounts">Discounts</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('ecom-affiliates') }}" class="waves-effect">
                                <i class="bx bx-group"></i>
                                <span key="t-affiliates">Affiliates</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('ecom-triggers') }}" class="waves-effect">
                                <i class="bx bx-key"></i>
