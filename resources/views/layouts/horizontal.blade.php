            ...
            <div class="modal-body">
                <form method="POST" id="change-password">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="horizontal-change-password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password" placeholder="Enter New Password">
