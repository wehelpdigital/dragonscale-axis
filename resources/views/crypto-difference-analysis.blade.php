...
@section('title') @lang('translation.Crypto_Difference_Analysis') @endsection
@section('css')
    <!-- Apexcharts -->
...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') Crypto Difference Analysis @endslot
    @endcomponent
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#useCurrentSetBtn').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route("crypto-difference-analysis.current-task") }}',
                    type: 'GET',
                    headers: {
            ...
            $('#cryptoAnalysisForm').on('submit', function(e) {
                ...
                if (validateForm()) {
                    ...
                    // Send AJAX request
                    $.ajax({
                        url: '{{ route("crypto-difference-analysis.generate") }}',
                        type: 'POST',
                        data: formData,
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
