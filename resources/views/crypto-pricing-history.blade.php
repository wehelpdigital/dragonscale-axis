...
@section('title') Crypto Ladder History @endsection

@section('content')

@component('components.breadcrumb')
@slot('li_1') Crypto @endslot
@slot('title') Crypto Ladder History @endslot
@endcomponent
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('crypto-pricing-history') }}" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <a href="{{ route('crypto-pricing-history') }}" class="btn btn-secondary">Clear</a>
                        </div>
                    </div>
                </form>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Chart data from PHP
    const ladderData = @json($ladderData);
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (validateForm()) {
            ...
            // Make AJAX request
            fetch('{{ route("crypto-difference-calculation") }}', {
                method: 'POST',
                headers: {
