...
@section('title') Edit Crop Breed @endsection
...
@section('content')
    ...
    <div class="card">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="card-title mb-0">
                        <i class="bx bx-edit text-primary me-2"></i>Edit Crop Breed
                    </h4>
                    <p class="text-secondary mb-0 mt-1">Update the details of {{ $breed->name }}</p>
                </div>
                <div>
                    <a href="{{ route('knowledgebase.crop-breeds.show', ['id' => $breed->id]) }}" class="btn btn-outline-info me-2">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('knowledgebase.crop-breeds.update', ['id' => $breed->id]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                   id="name" name="name" value="{{ old('name', $breed->name) }}" placeholder="e.g., NSIC Rc222">
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('manufacturer') is-invalid @enderror"
                                   id="manufacturer" name="manufacturer" value="{{ old('manufacturer', $breed->manufacturer) }}" placeholder="e.g., PhilRice, Pioneer, Syngenta">
                            @error('manufacturer')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('cropType') is-invalid @enderror" id="cropType" name="cropType">
                                ...
                                @foreach($cropTypeLabels as $value => $label)
                                    <option value="{{ $value }}" {{ old('cropType', $breed->cropType) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('cropType')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('breedType') is-invalid @enderror" id="breedType" name="breedType">
                                ...
                                @foreach($breedTypeLabels as $value => $label)
                                    <option value="{{ $value }}" {{ old('breedType', $breed->breedType) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('breedType')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-4 mb-3 corn-type-section" id="cornTypeSection">
                            ...
                            <select class="form-select @error('cornType') is-invalid @enderror" id="cornType" name="cornType">
                                ...
                                @foreach($cornTypeLabels as $value => $label)
                                    <option value="{{ $value }}" {{ old('cornType', $breed->cornType) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @error('cornType')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('potentialYield') is-invalid @enderror"
                                   id="potentialYield" name="potentialYield" value="{{ old('potentialYield', $breed->potentialYield) }}" placeholder="e.g., 6-8 tons/ha">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('maturityDays') is-invalid @enderror"
                                   id="maturityDays" name="maturityDays" value="{{ old('maturityDays', $breed->maturityDays) }}" placeholder="e.g., 110-115 days">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('geneProtection') is-invalid @enderror"
                                   id="geneProtection" name="geneProtection" value="{{ old('geneProtection', $geneProtectionString) }}"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('characteristics') is-invalid @enderror"
                                      ...
                                      placeholder="e.g., Semi-dwarf plant type, good tillering ability, intermediate amylose content">{{ old('characteristics', $breed->characteristics) }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($breed->imagePath)
                                <div class="current-file">
                                    <img src="{{ asset($breed->imagePath) }}" alt="Current image">
                                    <div class="file-info">
                                        <small class="text-dark">Current image</small>
                            ...
                            <div class="file-preview-container" id="imagePreview" style="display: none;">
                                <p class="text-dark mb-1"><small>New image preview:</small></p>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($breed->brochurePath)
                                <div class="current-file">
                                    ...
                                    <div class="file-info">
                                        <a href="{{ asset($breed->brochurePath) }}" target="_blank" class="text-dark">View current brochure</a>
                                        <div class="form-check mt-1">
                                            <input class="form-check-input" type="checkbox" name="removeBrochure" id="removeBrochure" value="1">
                                            <label class="form-check-label text-danger" for="removeBrochure">
                                                <small>Remove brochure</small>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="url" class="form-control @error('sourceUrl') is-invalid @enderror"
                                   id="sourceUrl" name="sourceUrl" value="{{ old('sourceUrl', $breed->sourceUrl) }}"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('relatedInformation') is-invalid @enderror"
                                      ...
                                      placeholder="Any additional notes, recommendations, or important details about this variety">{{ old('relatedInformation', $breed->relatedInformation) }}</textarea>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bx bx-save me-1"></i>Update Breed
                    </button>
                </div>
            </form>
        </div>
