...
@slot('title') Add New Course @endslot
@endcomponent
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('anisenso-courses.store') }}" method="POST" enctype="multipart/form-data" id="courseForm">
                    @csrf
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('courseSmallDescription') is-invalid @enderror"
                                      ...
                                      placeholder="Enter a brief description of the course">{{ old('courseSmallDescription') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('courseBigDescription') is-invalid @enderror"
                                      ...
                                      placeholder="Enter detailed description of the course">{{ old('courseBigDescription') }}</textarea>
