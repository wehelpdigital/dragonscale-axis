                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="course-actions">
                                            <div class="d-flex flex-wrap gap-2 justify-content-center">
                                                <button type="button" class="btn btn-outline-primary btn-sm" onclick="viewCourse({{ $course->id }})">
                                                    <i class="bx bx-book-open me-1"></i> Contents
                                                </button>
                                                <button type="button" class="btn btn-outline-info btn-sm" onclick="viewComments({{ $course->id }})">
