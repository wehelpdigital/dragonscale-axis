...
@section('title') Edit Access Tag - {{ $tag->tagName }} @endsection
...
@slot('title') Edit Access Tag @endslot
@endcomponent
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="card-title-desc">Edit access tag "{{ $tag->tagName }}" for "{{ $course->courseName }}"</p>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tagName') is-invalid @enderror"
                                           id="tagName" name="tagName" value="{{ old('tagName', $tag->tagName) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('expirationLength') is-invalid @enderror"
                                           id="expirationLength" name="expirationLength" value="{{ old('expirationLength', $tag->expirationLength) }}"
...
$(document).ready(function() {
    console.log('Edit access tag page loaded for tag: {{ $tag->tagName }}');
});
