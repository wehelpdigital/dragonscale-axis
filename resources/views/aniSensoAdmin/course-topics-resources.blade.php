...
@section('title') Downloadable Resources - {{ $topic->topicTitle }} @endsection
...
@slot('title') Downloadable Resources @endslot
@endcomponent
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="card-title-desc">Manage downloadable resources for "{{ $topic->topicTitle }}"</p>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody id="resources-list">
                                ...
                                <tr class="resource-row" data-id="{{ $resource->id }}">
                                    ...
                                    <td>
                                        <a href="{{ asset($resource->fileUrl) }}" target="_blank" class="text-decoration-none">
                                            <strong>{{ $resource->fileName }}</strong>
                                        </a>
                                    </td>
                                    <td>
                                        <div class="d-flex gap-1">
                                            <button type="button" class="btn btn-outline-secondary btn-sm" onclick="copyToClipboard('{{ asset($resource->fileUrl) }}')">
...
$(document).ready(function() {
    console.log('Topic resources page loaded for: {{ $topic->topicTitle }}');
...
function updateResourceOrder() {
    ...
    $.ajax({
        url: '{{ route("anisenso-courses-topics-resources.order") }}',
        method: 'PUT',
        data: {
            _token: '{{ csrf_token() }}',
            resources: resources
...
function initializeDropzone() {
    dropzone = new Dropzone("#fileDropzone", {
        url: "{{ route('anisenso-courses-topics-resources.upload') }}",
        paramName: "file",
        maxFilesize: 50, // MB
