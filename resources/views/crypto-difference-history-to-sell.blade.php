...
@section('title') @lang('translation.Crypto_Difference_History_To_Sell') @endsection
@section('css')
    <!-- Datepicker -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('crypto-difference-history-to-sell') }}" class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('crypto-difference-history-to-sell') }}" class="btn btn-secondary">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
...
@section('script')
    ...
    <script>
        ...
        function loadHistoricalData(page = 1) {
            ...
            // Make AJAX request
            fetch(`{{ route('crypto-difference-history-to-sell.data') }}?${params.toString()}`, {
                headers: {
            ...
            data.forEach((record) => {
                ...
                html += `
                    <tr>
                        <td>${record.date}</td>
                        <td>${record.time}</td>
                        <td>${parseFloat(record.current_cash_value).toFixed(8)} BTC</td>
                        <td>₱${parseFloat(record.starting_coin_value).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
