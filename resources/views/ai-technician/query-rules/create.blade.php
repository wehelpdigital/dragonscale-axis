...
@section('title') Add Query Rule @endsection
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0 text-dark">
                        <i class="bx bx-plus-circle text-primary me-2"></i>Add New Query Rule
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('ai-technician.query-rules.store') }}" method="POST" id="ruleForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ruleName') is-invalid @enderror"
                                   id="ruleName" name="ruleName" value="{{ old('ruleName') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('ruleCategory') is-invalid @enderror"
                                        ...
                                        @foreach($categories as $key => $label)
                                            <option value="{{ $key }}" {{ old('ruleCategory', 'general') === $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('ruleCategory')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('priority') is-invalid @enderror"
                                           id="priority" name="priority" value="{{ old('priority', 50) }}"
                                           min="0" max="1000">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('ruleDescription') is-invalid @enderror"
                                      ...
                                      maxlength="1000">{{ old('ruleDescription') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('rulePrompt') is-invalid @enderror"
                                      id="rulePrompt" name="rulePrompt" rows="8"
                                      placeholder="Enter the instruction that will be injected into AI queries...

Example:
When answering questions about crop prices, always specify the currency (PHP) and include the date of the price information. If prices are outdated, mention this clearly."
                                      maxlength="5000">{{ old('rulePrompt') }}</textarea>
                            <div class="d-flex justify-content-between">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0 text-dark">
                        <i class="bx bx-category me-2"></i>Category Guide
                    </h6>
                </div>
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush" style="font-size: 0.85rem;">
                        <li class="list-group-item">
                            <strong class="text-dark">General</strong>
                            <p class="mb-0 text-secondary small">Broad rules that apply to most queries</p>
                        </li>
                        <li class="list-group-item">
                            <strong class="text-dark">Terminology</strong>
                            <p class="mb-0 text-secondary small">Rules about specific words, names, or technical terms</p>
                        </li>
                        <li class="list-group-item">
                            <strong class="text-dark">Data Preference</strong>
                            <p class="mb-0 text-secondary small">Rules about data sources, recency, accuracy</p>
                        </li>
                        <li class="list-group-item">
                            <strong class="text-dark">Formatting</strong>
                            <p class="mb-0 text-secondary small">Rules about how information is presented</p>
                        </li>
                        <li class="list-group-item">
                            <strong class="text-dark">Response Style</strong>
                            <p class="mb-0 text-secondary small">Rules about tone, detail level, structure</p>
                        </li>
                    </ul>
                </div>
            </div>
