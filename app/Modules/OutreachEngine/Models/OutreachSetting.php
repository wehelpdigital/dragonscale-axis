...
class OutreachSetting extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'maxFollowUps',
        'noReplyAfterDays',
        'replyDelayMinMinutes',
        'replyDelayMaxMinutes',
        'trackOpens',
        'trackingDomain',
        'autoSuppressBounced',
    ...
    protected $casts = [
        ...
        'aiMinGapMinutes' => 'integer',
        'aiMaxGapMinutes' => 'integer',
        'aiMaxPerDay' => 'integer',
        'followUpDelayDays' => 'integer',
        'maxFollowUps' => 'integer',
        'noReplyAfterDays' => 'integer',
        'replyDelayMinMinutes' => 'integer',
        'replyDelayMaxMinutes' => 'integer',
        'trackOpens' => 'boolean',
        'autoSuppressBounced' => 'boolean',
        'autoSuppressComplaints' => 'boolean',
        'flowCronEnabled' => 'boolean',
    ...
    protected static function defaults(): array
    {
        return [
            ...
            'minDelayMinutes' => 3,
            'maxDelayMinutes' => 17,
            'defaultGridRadiusKm' => 30.00,
            'minGridRadiusKm' => 0.25,
