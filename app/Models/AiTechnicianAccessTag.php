...
class AiTechnicianAccessTag extends BaseModel
{
    protected $table = 'ai_technician_access_tags';
    ...
    /**
     * Get clients that have this access tag.
     */
    public function clients()
    {
        return $this->hasMany(AiTechnicianClientAccess::class, 'accessTagId');
    }
