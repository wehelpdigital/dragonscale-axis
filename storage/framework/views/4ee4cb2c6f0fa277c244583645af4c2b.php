<?php $__env->startSection('title'); ?> Edit Chapter - <?php echo e($chapter->chapterTitle); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Edit Chapter <?php $__env->endSlot(); ?>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="card-title-desc">Update chapter information for "<?php echo e($course->courseName); ?>"</p>
                </div>
            ...
            <div class="card-body">
                <form action="<?php echo e(route('anisenso-courses.chapters.update', $chapter->id)); ?>" method="POST" enctype="multipart/form-data" id="chapterForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   id="chapterTitle" name="chapterTitle" value="<?php echo e(old('chapterTitle', $chapter->chapterTitle)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      placeholder="Enter chapter description"><?php echo e(old('chapterDescription', $chapter->chapterDescription)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($chapter->chapterCoverPhoto): ?>
                                <div class="mt-3">
                                    <label class="form-label">Current Cover Photo:</label>
                                    <div class="text-center">
                                        <img src="<?php echo e(asset($chapter->chapterCoverPhoto)); ?>" alt="Current chapter cover" style="max-width: 150px; max-height: 150px; border-radius: 5px; border: 1px solid #dee2e6;">
                                    </div>
                                </div>
                            <?php endif; ?>
...
$(document).ready(function() {
    console.log('Edit chapter page loaded for: <?php echo e($chapter->chapterTitle); ?>');
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/aniSensoAdmin/courses-contents-edit.blade.php ENDPATH**/ ?>