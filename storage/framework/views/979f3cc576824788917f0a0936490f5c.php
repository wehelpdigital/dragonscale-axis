<?php $__env->startSection('title'); ?> Variant Videos <?php $__env->stopSection(); ?>
...
$(document).ready(function() {
    ...
    $('#saveVideoBtn').on('click', function() {
        ...
        // Send AJAX request
        $.ajax({
            url: "<?php echo e(route('ecom-products.variants.videos.upload')); ?>",
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
<?php $__env->slot('title'); ?> Variant Videos <?php $__env->endSlot(); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <p class="card-title-desc">Manage videos for: <strong><?php echo e($variant->ecomVariantName); ?></strong> (<?php echo e($product->productName); ?>)</p>
                    </div>
                        ...
                        <?php if($videos->count() > 0): ?>
                            <div class="masonry-grid" id="videoGrid">
                                <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="masonry-item" draggable="true" data-video-id="<?php echo e($video->id); ?>" data-video-order="<?php echo e($video->videoOrder); ?>">
                                        <div class="video-thumbnail" data-video-link="<?php echo e($video->videoLink); ?>">
                                            <img src="<?php echo e($video->thumbnail_url); ?>" alt="Video thumbnail" class="thumbnail-image" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            <div class="thumbnail-placeholder" style="display: none;">
                                                <i class="bx bx-play-circle"></i>
                                                <span>Click to play</span>
                                            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/ecommerce/products/variants/videos.blade.php ENDPATH**/ ?>