...
$(document).ready(function() {
    ...
    function loadPhilippineProvinces() {
        ...
        $.ajax({
            url: '<?php echo e(route("ecom-orders-custom-add.philippine-provinces")); ?>',
            type: 'GET',
            success: function(response) {
    ...
    function loadMunicipalities(province, callback) {
        ...
        $.ajax({
            url: '<?php echo e(route("ecom-orders-custom-add.philippine-municipalities")); ?>',
            type: 'GET',
    ...
    function calculateShippingCosts() {
        ...
        $.ajax({
            url: '<?php echo e(route("ecom-orders-custom-add.calculate-shipping")); ?>',
            type: 'POST',
            data: requestData,
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
