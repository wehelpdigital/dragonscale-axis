<?php $__env->startSection('title'); ?> Add Topic - <?php echo e($chapter->chapterTitle); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Add Topic <?php $__env->endSlot(); ?>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('anisenso-courses-topics.store')); ?>" method="POST" id="topicForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/aniSensoAdmin/course-topics-add.blade.php ENDPATH**/ ?>