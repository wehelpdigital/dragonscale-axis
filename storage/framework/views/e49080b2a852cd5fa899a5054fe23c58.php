<?php $__env->startSection('title'); ?> Edit Access Tag - <?php echo e($tag->tagName); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Edit Access Tag <?php $__env->endSlot(); ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="card-title">Edit Access Tag</h4>
                    <p class="card-title-desc">Edit access tag "<?php echo e($tag->tagName); ?>" for "<?php echo e($course->courseName); ?>"</p>
                </div>
            ...
            <div class="card-body">
                <form action="<?php echo e(route('anisenso-courses-tags.update', $tag->id)); ?>" method="POST" id="editAccessTagForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           id="tagName" name="tagName" value="<?php echo e(old('tagName', $tag->tagName)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                           id="expirationLength" name="expirationLength" value="<?php echo e(old('expirationLength', $tag->expirationLength)); ?>"
                    ...
                    <div class="form-section">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-save me-1"></i> Update Access Tag
                            </button>
                        </div>
                    </div>
                </form>
...
$(document).ready(function() {
    console.log('Edit access tag page loaded for tag: <?php echo e($tag->tagName); ?>');
});

// Form validation
$('#editAccessTagForm').on('submit', function(e) {
    let isValid = true;
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/aniSensoAdmin/course-tags-edit.blade.php ENDPATH**/ ?>