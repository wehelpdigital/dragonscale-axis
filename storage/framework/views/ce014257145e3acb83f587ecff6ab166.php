<?php $__env->startSection('title'); ?> Course Access Tags - <?php echo e($course->courseName); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Access Tags <?php $__env->endSlot(); ?>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="card-title-desc">Manage access tags for "<?php echo e($course->courseName); ?>"</p>
                </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr data-tag-id="<?php echo e($tag->id); ?>">
                                            <td><?php echo e($tag->tagName); ?></td>
                                            <td><?php echo e($tag->expirationLength); ?></td>
                                            <td class="text-center">
                                                <div class="d-flex gap-1 justify-content-center">
                                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="editTag(<?php echo e($tag->id); ?>)">
                                                        <i class="bx bx-edit"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="deleteTag(<?php echo e($tag->id); ?>)">
...
$(document).ready(function() {
    console.log('Course access tags page loaded for: <?php echo e($course->courseName); ?>');
...
function addNewAccessTag() {
    ...
    window.location.href = `/anisenso-courses-tags-add?id=<?php echo e($course->id); ?>`;
}
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/aniSensoAdmin/course-tags.blade.php ENDPATH**/ ?>