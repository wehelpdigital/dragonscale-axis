        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo e(route('ecom-products.create')); ?>" class="btn btn-primary">
                        ...
                        <form method="GET" action="<?php echo e(route('ecom-products')); ?>" class="d-flex">
                            <select name="store" class="form-select me-2">
                                ...
                                <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($store); ?>" <?php echo e(request('store') == $store ? 'selected' : ''); ?>>
                                        <?php echo e($store); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex flex-wrap gap-1 justify-content-center">
                                            <a href="<?php echo e(route('ecom-products.variants', ['id' => $product->id])); ?>"
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-primary badge-style status-btn" title="Status"
                                                    ...
                                                    data-current-status="<?php echo e($product->isActive ? 1 : 0); ?>">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/ecommerce/products/index.blade.php ENDPATH**/ ?>