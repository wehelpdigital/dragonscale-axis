<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Crypto_Difference_History_To_Buy'); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> To Buy <?php $__env->endSlot(); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('crypto-difference-history-to-buy')); ?>" class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo e(route('crypto-difference-history-to-buy')); ?>" class="btn btn-secondary">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/crypto-difference-history-to-buy.blade.php ENDPATH**/ ?>