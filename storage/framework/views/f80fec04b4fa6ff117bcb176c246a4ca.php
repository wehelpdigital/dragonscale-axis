...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('anisenso-courses.update', $course->id)); ?>" method="POST" enctype="multipart/form-data" id="courseForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           id="courseName" name="courseName" value="<?php echo e(old('courseName', $course->courseName)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      placeholder="Enter a brief description of the course"><?php echo e(old('courseSmallDescription', $course->courseSmallDescription)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      placeholder="Enter detailed description of the course"><?php echo e(old('courseBigDescription', $course->courseBigDescription)); ?></textarea>
                            ...
                            <?php if($course->courseImage): ?>
                                <div class="mt-3">
                                    ...
                                    <div class="text-center">
                                        <img src="<?php echo e(asset($course->courseImage)); ?>" alt="Current course image" style="max-width: 150px; max-height: 150px; border-radius: 5px; border: 1px solid #dee2e6;">
                                    </div>
                                </div>
                            <?php endif; ?>
