...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="Town" <?php echo e(old('shipCoverage', $product->shipCoverage) == 'Town' ? 'selected' : ''); ?>>Town</option>
                                        <option value="Province" <?php echo e(old('shipCoverage', $product->shipCoverage) == 'Province' ? 'selected' : ''); ?>>Province</option>
                                        <option value="Region" <?php echo e(old('shipCoverage', $product->shipCoverage) == 'Region' ? 'selected' : ''); ?>>Region</option>
                                        <option value="National" <?php echo e(old('shipCoverage', $product->shipCoverage) == 'National' ? 'selected' : ''); ?>>National</option>
                                    </select>
