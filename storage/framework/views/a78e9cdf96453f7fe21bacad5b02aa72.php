    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="addProductForm" method="POST" action="<?php echo e(route('ecom-products.store')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                  ...
                                  rows="4"
                                  placeholder="Enter product description"><?php echo e(old('productDescription')); ?></textarea>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/ecommerce/products/create.blade.php ENDPATH**/ ?>