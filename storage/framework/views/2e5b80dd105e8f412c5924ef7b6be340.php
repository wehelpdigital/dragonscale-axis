<?php $__env->startSection('title'); ?> Crypto Income Logger <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Crypto <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Crypto Income Logger <?php $__env->endSlot(); ?>
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <form method="GET" action="<?php echo e(route('crypto-income-logger')); ?>" id="filterForm">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="task_type" name="task_type">
                                                    ...
                                                    <?php $__currentLoopData = $taskTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($type); ?>" <?php echo e($taskType == $type ? 'selected' : ''); ?>>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="coin_type" name="coin_type">
                                                    ...
                                                    <?php $__currentLoopData = $coinTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($coin); ?>" <?php echo e($coinType == $coin ? 'selected' : ''); ?>>
                                                            <?php echo e(strtoupper($coin)); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a href="<?php echo e(route('crypto-income-logger')); ?>" class="btn btn-secondary">
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-end">
                            <a href="<?php echo e(route('crypto-income-logger-add')); ?>" class="btn btn-primary btn-lg">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $incomeLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <span class="badge bg-primary rounded-pill">
                                            <?php echo e(strtoupper($log->taskCoin)); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($log->taskType === 'to buy' ? 'danger' : 'success'); ?> rounded-pill">
                                            <?php echo e(ucfirst($log->taskType)); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e($log->transactionDateTime ? $log->transactionDateTime->format('F j, Y') : $log->created_at->format('F j, Y')); ?></td>
                                    <td><?php echo e($log->transactionDateTime ? $log->transactionDateTime->format('g:i A') : $log->created_at->format('g:i A')); ?></td>
                                    <td class="text-end">₱<?php echo e(number_format($log->originalPhpValue, 2)); ?></td>
                                    <td class="text-end">₱<?php echo e(number_format($log->newPhpValue, 2)); ?></td>
                                    <td class="text-end">
                                        <span class="badge bg-<?php echo e(($log->newPhpValue - $log->originalPhpValue) >= 0 ? 'success' : 'danger'); ?> rounded-pill">
                                            ₱<?php echo e(number_format($log->newPhpValue - $log->originalPhpValue, 2)); ?>
                                    ...
                                    <td class="text-center">
                                        <button type="button"
                                                ...
                                                data-coin="<?php echo e($log->taskCoin); ?>"
                                                data-type="<?php echo e($log->taskType); ?>"
                                                data-datetime="<?php echo e($log->transactionDateTime ? $log->transactionDateTime->format('M j, Y g:i A') : $log->created_at->format('M j, Y g:i A')); ?>">
                ...
                <!-- Pagination -->
                <?php if($incomeLogs->hasPages()): ?>
                    <div class="d-flex justify-content-center mt-4">
                        <?php echo e($incomeLogs->appends(request()->query())->links()); ?>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="text-center p-3 bg-light rounded">
                                            ...
                                            <h4 class="text-danger mb-0">₱<?php echo e(number_format($totalToBuyDifference, 2)); ?></h4>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-center p-3 bg-light rounded">
                                            <h6 class="text-muted mb-1">Filtered To Buy Difference</h6>
                                            <h4 class="text-danger mb-0">₱<?php echo e(number_format($filteredToBuyDifference, 2)); ?></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="text-center p-3 bg-light rounded">
                                            ...
                                            <h4 class="text-success mb-0">₱<?php echo e(number_format($totalToSellDifference, 2)); ?></h4>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-center p-3 bg-light rounded">
                                            <h6 class="text-muted mb-1">Filtered To Sell Difference</h6>
                                            <h4 class="text-success mb-0">₱<?php echo e(number_format($filteredToSellDifference, 2)); ?></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/crypto-income-logger.blade.php ENDPATH**/ ?>