<?php $__env->startSection('title'); ?> Variant Photos <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Variant Photos <?php $__env->endSlot(); ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <p class="card-title-desc">Manage photos for: <strong><?php echo e($variant->ecomVariantName); ?></strong> (<?php echo e($product->productName); ?>)</p>
                    </div>
                    ...
                    <div class="col-12">
                            ...
                            <div class="masonry-grid" id="imageGrid">
                                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="masonry-item" draggable="true" data-image-id="<?php echo e($image->id); ?>" data-image-order="<?php echo e($image->imageOrder); ?>">
                                        <a href="<?php echo e($image->imageLink); ?>" data-lightbox="variant-images" data-title="Variant Image">
                                            <img src="<?php echo e($image->imageLink); ?>" alt="Variant Image" loading="lazy">
                                        </a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('ecom-products.variants.photos.upload')); ?>" class="dropzone" id="imageDropzone">
                    <?php echo csrf_field(); ?>
...
$(document).ready(function() {
    ...
    const myDropzone = new Dropzone("#imageDropzone", {
        url: "<?php echo e(route('ecom-products.variants.photos.upload')); ?>",
        paramName: "image",
        maxFilesize: 10, // MB
    ...
    function updateImageOrder() {
        ...
        // Send to server
        $.ajax({
            url: "<?php echo e(route('ecom-products.variants.photos.reorder')); ?>",
            method: 'PATCH',
            data: {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/ecommerce/products/variants/photos.blade.php ENDPATH**/ ?>