<?php $__env->startSection('title'); ?> Variant Triggers <?php $__env->stopSection(); ?>
...
<?php $__env->slot('li_4'); ?> Triggers <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Variant Triggers <?php $__env->endSlot(); ?>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <?php if($variant && $product): ?>
                            <p class="card-title-desc">Manage triggers for: <strong><?php echo e($variant->ecomVariantName); ?></strong> (<?php echo e($product->productName); ?>)</p>
                        <?php else: ?>
                        ...
                        <div class="table-responsive" id="mainTableContainer">
                            <table class="table table-bordered table-striped" id="mainVariantTagsTable">
                                ...
                                <tbody id="variantTagsTableBody">
                                    <?php $__currentLoopData = $variantTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$(document).ready(function() {
    ...
    function loadAvailableTags() {
        const variantId = '<?php echo e($variant->id ?? ""); ?>';
        ...
        $.ajax({
            url: '<?php echo e(route("ecom-products.variants.triggers.available-tags")); ?>',
            method: 'GET',
            data: {
                id: variantId
            },
    ...
    function refreshVariantTags() {
        ...
        $.ajax({
            url: '<?php echo e(route("ecom-products.variants.triggers")); ?>',
            method: 'GET',
            headers: {
    ...
    $('#confirmDeleteTag').click(function() {
        ...
        $.ajax({
            url: '<?php echo e(route("ecom-products.variants.triggers.delete-tag", ["id" => ":id"])); ?>'.replace(':id', tagId),
            method: 'DELETE',
            data: {
    ...
    $('#saveTriggerTags').click(function() {
        ...
        $.ajax({
            url: '<?php echo e(route("ecom-products.variants.triggers.save-tags")); ?>',
            method: 'POST',
            data: {
                variantId: '<?php echo e($variant->id ?? ""); ?>',
                tagIds: selectedTags,
                _token: '<?php echo e(csrf_token()); ?>'
            },
                        success: function(response) {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/ecommerce/products/variants/triggers.blade.php ENDPATH**/ ?>