<?php $__env->startSection('title'); ?> Product Variants <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Product Variants <?php $__env->endSlot(); ?>
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <p class="card-title-desc">Manage variants for: <strong><?php echo e($product->productName); ?></strong></p>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo e(route('ecom-products.variants.create', ['id' => $product->id])); ?>" class="btn btn-primary">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($variant->ecomVariantName); ?></td>
                                    <td>
                                        <span class="badge bg-<?php echo e($variant->stocksAvailable > 0 ? 'success' : 'danger'); ?>">
                                            <?php echo e($variant->stocksAvailable); ?>

                                        </span>
                                    </td>
                                    <td>₱<?php echo e(number_format($variant->ecomVariantPrice, 2)); ?></td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex flex-wrap gap-1 justify-content-center">
                                            <a href="<?php echo e(route('ecom-products.variants.photos', ['id' => $variant->id])); ?>"
                                               class="btn btn-sm btn-outline-info badge-style" title="Photos">
                                                <i class="bx bx-image me-1"></i>Photos
                                            </a>
                                            <a href="<?php echo e(route('ecom-products.variants.videos', ['id' => $variant->id])); ?>"
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-primary badge-style variant-status-btn" title="Status"
                                                    ...
                                                    data-current-status="<?php echo e($variant->isActive ? 1 : 0); ?>">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-secondary badge-style variant-stocks-btn" title="Stocks"
                                                    data-variant-id="<?php echo e($variant->id); ?>"
                                                    data-variant-name="<?php echo e($variant->ecomVariantName); ?>"
                                                    data-current-stocks="<?php echo e($variant->stocksAvailable); ?>">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/ecommerce/products/variants.blade.php ENDPATH**/ ?>