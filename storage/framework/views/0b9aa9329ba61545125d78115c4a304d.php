<?php $__env->startSection('title'); ?> Create New Discount <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Create New Discount <?php $__env->endSlot(); ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="discountForm" method="POST" action="<?php echo e(route('ecom-discounts.store')); ?>" novalidate>
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\btc-check\resources\views/ecommerce/discounts/create.blade.php ENDPATH**/ ?>